// Get all input items from previous cleanup nodes
const items = $input.all();

// Filter out items with errors (No HTML content found)
...
let markdown = "# Space News Digest\n\n";
...
// Add footer
markdown += "*End Of Article Content*\n";
